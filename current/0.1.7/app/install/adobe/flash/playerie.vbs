...
' запуск: im.vbs /install_adobe_flash_playerie
'
' @file       player.vbs
...
dim sNameProg: sNameProg = "Adobe Flash Player 11 ActiveX"
...
if version <> sCurrentVersion or version = "" then
	dim resultShell: resultShell = oShell.cmd("\\data\install\internet\flash_player\install_flash_player_ax_" & oOs.osArchitecture & "bit.exe -install")
end if